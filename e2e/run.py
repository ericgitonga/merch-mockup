...
Requires a server already running at BASE_URL (default http://127.0.0.1:5000)
— start one with `gunicorn app:app --bind 0.0.0.0:5000` first. Exits
non-zero if any test fails or errors, for use as a CI gate.
"""
